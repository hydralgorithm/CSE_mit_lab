          ...
          <main className="viewer">
            <div className="viewer-head">
              <div className="viewer-title">
                ...
                <span className="viewer-path">{selectedFile?.path || ''}</span>
              </div>
            ...
            {!selectedPath && !fileLoading ? (
              <div className="empty-state">
                <div className="empty-card">
                  <p className="section-label">Portal Ready</p>
                  <h2>Select a file to start.</h2>
                  <p className="empty-copy">
                    Use the left navigation or search bar to jump to a file instantly.
                  </p>
                  ...
                  <div className="empty-tips">
                    <span>Tip: try searching `exp12.c` or `SEM2`</span>
                  </div>
                </div>
              </div>
            ) : null}
